...
if mode is '2D':
    #params = np.ones(37)
    #params = np.loadtxt('./optim_data/cma/trial_190510_L2M2019CtrlEnv_2D_d0_best_w.txt')
    xrecentbest = open("./optim_data/cma/trial_190510_L2M2019CtrlEnv_2D_d0_xrecentbest.dat", "r")
    ...
    #np.savetxt('params_3D_init.txt', params_3)
elif mode is '3D':
    #params = np.ones(45)
    ...
    #xrecentbest = open("./optim_data/cma/trial_190510_L2M2019CtrlEnv_d0_xrecentbest.dat", "r")
    #for line in xrecentbest:
    #    pass
    #last = np.fromstring(line, sep=' ')
    #params = np.array(last[5:])
